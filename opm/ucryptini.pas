...
uses
  Forms, SysUtils, LazUTF8, LazFileUtils,StrUtils, INIFiles, md5, LCLVersion, Classes
...
// Hash the phrase to a standard 16 chars
...
Var
  ...
  iCount, iEqualsPos, iMD5HashEntry: integer;
...
var
  iCount, iTemp, iEqualsPos: integer;
  s, sKey, sValue: string;
  f: double;
...
begin
  ...
  begin
    ...
    if (iEqualsPos >= 2) then
      sKey := LeftStr(s, iEqualsPos - 1)
    else
      Continue;
    sValue := RightStr(s, Length(s) - iEqualsPos);
